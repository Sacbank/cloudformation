pipeline {
    ...
    parameters {
        ...
        string(name: 'Template1', defaultValue: 'C:\Users\sachin.bankar\OneDrive - BlazeClan Technologies Pvt. Ltd\Desktop\CFT\s3-bucket.yml', description: 'cloudformation template')
        string(name: 'Template2', defaultValue: 'C:\Users\sachin.bankar\OneDrive - BlazeClan Technologies Pvt. Ltd\Desktop\CFT\EC2-ubuntu2204-instance.yml', description: 'cloudformation template')
    }
